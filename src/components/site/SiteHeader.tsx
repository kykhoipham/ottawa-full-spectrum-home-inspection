...
const NAV = [
  ...
  { to: "/report-sample", label: "Sample" },
  { to: "/pricing", label: "Price\u00A0" },
  { to: "/trade-referrals", label: "Referrals" },
    ...
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/85 backdrop-blur-md">
      <div className="container-prose flex h-16 items-center justify-between gap-4">
        <Link to="/" className="flex items-center gap-2.5 group" onClick={() => setOpen(false)}>
          ...
          />
          <span className="font-display text-base sm:text-lg font-semibold text-foreground leading-snug tracking-tight max-w-[260px] sm:max-w-[360px]">
